...
import EditQuestion4 from "../Question/Edit_question4";
import UploadPic from "../Question/UploadPic";
    ...
    <>
     ...
     {isAuthenticated && (
          <>
            ...
            <Route path="/set-question2" element={<Question4 />} />
            <Route path="/edit-question" element={<Edit_question />} />
            <Route path="/edit-question2" element={<EditQuestion4 />} />
