  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-6">
      ...
      >
        ...
        <div className="mb-4">
          <label htmlFor="flow" className="block text-gray-700 font-bold mb-2">
            Choose Gender:
          </label>
          <select
            id="flow"
            {...register("flow", { required: "Gender selection is required" })}
            className="w-full p-2 border border-gray-300 rounded"
          >
          ...
          {errors.flow && (
            <p className="text-red-500 text-xs italic">{errors.flow.message}</p>
          )}
        </div>
        ...
        {/* 
        <div className="mb-4">
          <label htmlFor="SR_NO" className="block text-gray-700 font-bold mb-2">
            SR_NO:
          </label>
          <input
            type="number"
